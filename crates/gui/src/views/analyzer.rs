...
use itrtg_models::{
    base_growth_for_displayed_target, displayed_growth, parse_flexible_number,
    CampaignType, Element,
    MAGIC_EGG_GROWTH_MULT, PetAction,
};
...
pub use itrtg_planner::analyzer::*;

pub trait AnalyzerPersistence {
    fn apply_app_state(&mut self, state: &AppState);
    fn write_into(&self, state: &mut AppState);
}
impl AnalyzerPersistence for AnalyzerState {
...
#[cfg(test)]
mod tests {
    use itrtg_models::{MainStats, GrowthRequirement};
    use super::*;
